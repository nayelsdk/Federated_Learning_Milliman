...
def prepare_client_data(
    ...
    Retourne :
        ...
        - (X_test_std, y_test, exposure_test) : données de test standardisées
        - (X_train_std, y_train, exposure_train) : données d'entraînement standardisées
    ...
    # Standardisation des features (hors exposure)
    ...
    return (
        batches, 
        (X_test_std, y_test, exposure_test), 
        (X_train_std, y_train, exposure_train), 
        local_model
    )

...
# Chemin vers les données Belgique
data_path = "/home/onyxia/work/Federated_Learning_Milliman/data/belgium_data.csv"
...
class BelgiumClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        print(f"Belgium training done for round {config['rnd']}")
